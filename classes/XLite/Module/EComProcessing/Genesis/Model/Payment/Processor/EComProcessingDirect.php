 ...
 */
class EComProcessingDirect extends \XLite\Module\EComProcessing\Genesis\Model\Payment\Processor\AEComProcessing
{
    ...
    public function isAvailable(\XLite\Model\Payment\Method $method)
    {
        return parent::isAvailable($method)
            && \XLite\Module\EComProcessing\Genesis\Main::isStoreOverSecuredConnection();
    }
    ...
    protected function collectInitialPaymentData()
    {
        ...
        $card_info = array();
        $card_info['card_holder'] = $requestData['ecomprocessing-direct-card-holder'];
        $card_info['card_number'] = str_replace("-", "", $requestData['ecomprocessing-direct-card-number']);

        $card_info['expiration'] = $requestData['ecomprocessing-direct-card-expiry'];
        ...
        $card_info['cvv'] = $requestData['ecomprocessing-direct-card-cvc'];
