...
HTML;
    ...
    protected static function log($data)
    {
        if (LC_DEVELOPER_MODE) {
            ...
            \XLite\Logger::logCustom('ecomprocessing', (string)$data);
        }
    }
    ...
    {
        return \XLite\Module\EComprocessing\Genesis\Main::isCoreVersion52();
    }
    ...
    {
        return \XLite\Module\EComprocessing\Genesis\Main::isCoreAboveVersion53();
    }
